...
// // --------------------------------------------------------------------------------------
// // d√©but de la zone attribu√©e au d√©veloppeur 1 (Ogu) : lignes 200 √† 299
// // --------------------------------------------------------------------------------------

// // test de la mÈthode existeAdrMailUtilisateur ----------------------------------------------------
// // modifiÈ par Jim le 12/8/2018
...
// // test de la mÈthode autoriseAConsulter ----------------------------------------------------------
// // modifiÈ par Jim le 13/8/2018
...
// // test de la mÈthode creerUneAutorisation ---------------------------------------------------------
// // modifiÈ par Jim le 13/8/2018
// echo "<h3>Test de creerUneAutorisation : </h3>";
// if ($dao->creerUneAutorisation(2, 1)) $ok = "oui"; else $ok = "non";
// echo "<p>La crÈation de l'autorisation de l'utilisateur 2 vers l'utilisateur 1 a rÈussi : <b>" . $ok . "</b><br>";
// // la mÍme autorisation ne peut pas Ítre enregistrÈe 2 fois
// if ($dao->creerUneAutorisation(2, 1)) $ok = "oui"; else $ok = "non";
// echo "<p>La crÈation de l'autorisation de l'utilisateur 2 vers l'utilisateur 1 a rÈussi : <b>" . $ok . "</b><br>";

// // test de la mÈthode getLesUtilisateursAutorisant ------------------------------------------------
// // modifiÈ par Jim le 13/8/2018
// // test de la mÈthode getLesUtilisateursAutorisant ------------------------------------------------
// // modifiÈ par Jim le 13/8/2018
...
// // test de la mÈthode getLesUtilisateursAutorises -------------------------------------------------
// // modifiÈ par Jim le 13/8/2018
// echo "<h3>Test de getLesUtilisateursAutorises(idUtilisateur) : </h3>";
// $lesUtilisateurs = $dao->getLesUtilisateursAutorises(2);
// $nbReponses = sizeof($lesUtilisateurs);
// echo "<p>Nombre d'utilisateurs autorisÈs par l'utilisateur 2 : " . $nbReponses . "</p>";
// // affichage des utilisateurs
// foreach ($lesUtilisateurs as $unUtilisateur)
// {	echo ($unUtilisateur->toString());
// echo ('<br>');
...
// test de la mÈthode getToutesLesTraces ----------------------------------------------------------
// modifiÈ par Jim le 14/8/2018
...
// --------------------------------------------------------------------------------------
// d√©but de la zone attribu√©e au d√©veloppeur 2 (vincent) : lignes 300 √† 399
// --------------------------------------------------------------------------------------
// test de la mÈthode getLesUtilisateursAutorisant ------------------------------------------------
// modifiÈ par Jim le 13/8/2018
echo "<h3>Test de getLesUtilisateursAutorisant(idUtilisateur) : </h3>";
...
// test de la mÈthode supprimerUneAutorisation ----------------------------------------------------
// modifiÈ par Jim le 13/8/2018
echo "<h3>Test de supprimerUneAutorisation : </h3>";
// on crÈe une autorisation
if ($dao->creerUneAutorisation(2, 1)) $ok = "oui"; else $ok = "non";
echo "<p>La crÈation de l'autorisation de l'utilisateur 2 vers l'utilisateur 1 a rÈussi : <b>" . $ok . "</b><br>";
// puis on la supprime
if ($dao->supprimerUneAutorisation(2, 1)) $ok = "oui"; else $ok = "non";
echo "<p>La suppression de l'autorisation de l'utilisateur 2 vers l'utilisateur 1 a rÈussi : <b>" . $ok . "</b><br>";
...
// --------------------------------------------------------------------------------------
// d√©but de la zone attribu√©e au d√©veloppeur 3 (xxxxxxxxxxxxxxxxxxxx) : lignes 400 √† 499
// --------------------------------------------------------------------------------------
